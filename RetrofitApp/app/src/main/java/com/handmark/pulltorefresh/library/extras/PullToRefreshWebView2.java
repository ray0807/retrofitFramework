 ...
 * {@link com.handmark.pulltorefresh.library.PullToRefreshWebView} which
 ...
 * <p/>
 * <ul>
 * <li>{@link com.handmark.pulltorefresh.library.PullToRefreshWebView} doesn't
 * work correctly because you're using <code>overflow:scroll</code> or something
 * else which means {@link android.webkit.WebView#getScrollY()} doesn't return
 * correct values.</li>
