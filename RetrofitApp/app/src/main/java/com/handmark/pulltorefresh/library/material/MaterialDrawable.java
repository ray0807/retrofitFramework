...
package com.handmark.pulltorefresh.library.material;
...
//    @IntDef({LARGE, DEFAULT})
    ...
    public MaterialDrawable(Context context, LoadingLayout parent) {
...
//        mCircle.getPaint().setColor(Color.WHITE);
        mCircle.getPaint().setColor(getContext().getResources().getColor(R.color.general_background_color));
    }
