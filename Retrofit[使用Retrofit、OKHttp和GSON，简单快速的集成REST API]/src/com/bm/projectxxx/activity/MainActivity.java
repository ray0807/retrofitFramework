...
import com.bm.projectxxx.api.PicassoFactory;
...
public class MainActivity extends BaseActivity implements OnClickListener {
	...
	private List<RandomBean> listData = new ArrayList<RandomBean>();
	...
	public void init() {
		...
		hideIvLeftOperate();
		setRightOperateIcon(R.drawable.general_add_icon);
...
//		Picasso.with(this).load(file).placeholder(R.drawable.default_icon).into(civView);
		PicassoFactory
				...
				.placeholder(R.drawable.default_icon).into(civView);
