...
import com.handmark.pulltorefresh.library.material.CirclesDrawable;
import com.handmark.pulltorefresh.library.material.MaterialDrawable;
import com.handmark.pulltorefresh.library.material.RefreshDrawable;
import com.handmark.pulltorefresh.library.material.RingDrawable;
import com.handmark.pulltorefresh.library.material.WaterDropDrawable;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection,
        ...
        // add by zhaocl, 2015-04-27
        final int type = attrs.getInteger(R.styleable.PullRefreshLayout_type, STYLE_MATERIAL);
        final int colorsId = attrs.getResourceId(R.styleable.PullRefreshLayout_colors, R.array.google_colors);
...
//        mRefreshDrawable.setPercent(1.0f);
        mHeaderImage.setImageDrawable(mRefreshDrawable);
    }
